...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.devoxx.alfioadapter.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.devoxx.alfioadapter.repository.UserRepository.USERS_BY_EMAIL_CACHE);
