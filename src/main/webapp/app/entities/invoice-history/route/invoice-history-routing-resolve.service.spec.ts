...
describe('InvoiceHistory routing resolve service', () => {
  ...
  let resultInvoiceHistory: IInvoiceHistory | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IInvoiceHistory if id is not provided', () => {
      // GIVEN
      ...
      expect(resultInvoiceHistory).toEqual(new InvoiceHistory());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as InvoiceHistory })));
      mockActivatedRouteSnapshot.params = { id: 123 };
